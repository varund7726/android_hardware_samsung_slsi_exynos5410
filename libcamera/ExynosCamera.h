...
public:
    ...
    //! Starts capturing and drawing preview frames to the screen.
    bool            startPreview2(void);
    //! Stop preview
    bool            stopPreview2(void);
    //! Check preview start
    bool            flagStartPreview(void);
    //! Check preview start
    bool            flagStartPreview2(void);
    ...
    //! Gets preview's buffer
    bool            getPreviewBuf2(ExynosBuffer *buf, bool *isValid);
    //! Put(dq) preview's buffer
    bool            putPreviewBuf2(ExynosBuffer *buf);
    ...
    //! Gets ISP's buffer2
    bool            getISPBuf2(ExynosBuffer *buf);
    //! Put(dq) ISP's buffer2
    bool            putISPBuf2(ExynosBuffer *buf);
    ...
    //! Start sensor
    bool            startSensor2(void);
    //! Stop sensor
    bool            stopSensor2(void);
    //! Check sensor start
    bool            flagStartSensor2(void);
    //! Gets sensor buffer
    bool            getSensorBuf2(ExynosBuffer *buf);
    //! Put sensor buffer
    bool            putSensorBuf2(ExynosBuffer *buf);
    ...
    bool            stopVideo(void);
    //! Start video
    bool            startVideo2(void);
    //! Stop video
    bool            stopVideo2(void);
    //! Check video start
    ...
    void            pictureOn(void);
    //! Start snapshot
    bool            startPicture2(void);
    //! Stop snapshot
    bool            stopPicture2(void);
    //! Check snapshot start
    bool            flagStartPicture2(void);
        //! Sets snapshot's buffer
    bool            setPictureBuf2(ExynosBuffer *buf);
    //! Gets snapshot's buffer
    bool            getPictureBuf2(ExynosBuffer *buf);
    //! Put(dq) snapshot's buffer
    bool            putPictureBuf2(ExynosBuffer *buf);
    //! Set Picture Req
    void            pictureOn2(void);
    ...
    bool            getPictureSize2(int *w, int *h);
    ...
    //! Returns the dimensions setting for preview pictures.
    bool            getPreviewSize2(int *w, int *h);
    ...
    bool            initSensor2(void);
    bool            deinitSensor2(void);

    bool            openSensor2(void);
    bool            closeSensor2(void);

    bool            openIsp2(void);
    bool            closeIsp2(void);

    bool            openPreview2(void);
    bool            closePreview2(void);

    bool            openPicture2(void);
    bool            closePicture2(void);
    ...
    bool            getSensorBufLpzsl(ExynosBuffer *buf);
    bool            putSensorBufLpzsl(ExynosBuffer *buf);
...
private:
    ...
    bool            m_tryPreviewStop2;
    bool            m_tryVideoStop2;
    bool            m_tryPictureStop2;
    ...
    bool             m_isFirtstIspStart2;
    bool             m_isFirtstSensorStart2;
    ...
    Mutex            m_requestMutex2;
    List<int>        m_sensorQ2;
    unsigned int     m_sensorFrameCount2;
    ...
    int              previewMetaBuffer2[VIDEO_MAX_FRAME];
    int              pictureMetaBuffer2[VIDEO_MAX_FRAME];
...
private:
    ...
    void            m_pushSensorQ2(int index);
    int             m_popSensorQ2(void);
    void            m_releaseSensorQ2(void);
